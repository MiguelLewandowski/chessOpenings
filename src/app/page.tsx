      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-100 fixed w-full z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="font-title text-2xl font-bold text-gray-900">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="font-interface bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                Cadastrar
              </button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="flex items-center justify-center gap-2 font-interface font-semibold text-gray-700 px-8 py-4 rounded-xl border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors">
                  Ver Demonstração
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <button className="font-interface font-semibold border-2 border-white text-white px-8 py-4 rounded-xl hover:bg-white hover:text-blue-600 transition-colors w-full sm:w-auto">
              Explorar Recursos
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Quiz de Perfil', 'Biblioteca de Aberturas', 'Lições Interativas', 'Análise de Progresso'].map((item) => (
                  <li key={item}>
